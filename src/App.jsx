...
function App() {
  ...
  const navigation = [
    { name: 'Anasayfa', id: 'dashboard', icon: LayoutDashboard },
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Sidebar */}
        <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex-shrink-0 lg:inset-y-auto lg:top-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
